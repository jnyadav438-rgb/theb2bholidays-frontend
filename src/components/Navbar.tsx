    ...
    <header className={`sticky top-0 z-50 transition-all ${scrolled ? 'glass shadow-premium' : 'bg-white'}`}>
      <div className="container-x flex items-center justify-between md:items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          {/* MAIN NAV */}
          <nav className="flex items-center justify-end md:justify-end md:gap-24 py-2">
            <div className="hidden md:flex items-center gap-16 text-sm font-medium text-slate-700">
          {links.map(l => (
